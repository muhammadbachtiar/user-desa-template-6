    ...
    <FloatingNode id={nodeId}>
      <li className="relative">
        <button
          ...
          {...getReferenceProps()}
          title={item.title}
          className={`inline-flex items-center rounded-sm px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold outline-none transition-all duration-200
                      focus-visible:ring-2 focus-visible:ring-ring
                      ${
                        open || isActiveBtn
                          ? isScrolled 
  ...
  return (
    <nav aria-label="Primary" className="w-full bg-transparent">
      <div className="mx-auto max-w-6xl">
        <FloatingTree>
          <ul role="menubar" className="flex w-full items-center justify-center gap-1.5 sm:gap-2.5 lg:gap-3 xl:gap-4 py-1.5 overflow-x-auto no-scrollbar">
            {top.map((it) => {
                ...
                return (
                  <li key={`${it.title}-${it.order}`} role="none">
                    <Link
                      ...
                      className={`inline-flex items-center rounded-sm px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold transition-all duration-200
                                  focus-visible:ring-2 focus-visible:ring-ring
                                  ${
                                    isActiveTop
                                      ? isScrolled
